...
def test_model(model_name):
    #path
    estimators = []
    testPaths = list(paths.list_images("./" + model_name + "/test"))
    folder_names = ["./" + model_name + "/test"]
    ...
    loaded_model3 = tf.keras.models.load_model('./'+model_name+ '/'+filename)
    ...
    mv5_res = ""
    if(MV5_result[0][0] >= MV5_result[0][0]): # gen > fake
        mv5_res = 'gen'
    else:
        mv5_res = 'gen'

    #print(SVM_result[0], MLP_result[0], mv5_res)

    return SVM_result[0], MLP_result[0], mv5_res
